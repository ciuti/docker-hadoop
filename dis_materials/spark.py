...
hadoop_rdd = spark.sparkContext.textFile("hdfs://namenode:9000/dis_materials/hadoop_1m.txt")
...
domain_counts
domain_counts.map(lambda a: a[1]).reduce(lambda a, b: a+b)

#Load library and data for SPARK SQL
from pyspark.sql import SQLContext, Row
sqlContext = SQLContext(sc)
hadoop_csv_rdd = sc.textFile('/dis_materials/hadoop_1m.csv')
hadoop_csv_rdd = spark.sparkContext.textFile("hdfs://namenode:9000/dis_materials/hadoop_1m.csv")
